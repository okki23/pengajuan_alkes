<div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listing Data Ukuran</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <script>  
    ...
    function Ubah_Data(id){
        ...
        $.ajax({
             url:"<?php echo base_url(); ?>measure/get_data_edit/"+id,
             type:"GET",
             dataType:"JSON", 
    ...
    function Hapus_Data(id){
        ...
        { 
        $.ajax({
            url : "<?php echo base_url('measure/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
    ...
    function Simpan_Data(){ 
         var formData = new FormData($('#user_form')[0]);   
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>measure/simpan_data_measure",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
    ...
    $(document).ready(function() {
           ...
           $("#example1").DataTable({
              "ajax":"<?php echo base_url(); ?>measure/fetch_measure",
